	...
	public TestBase() { // create constructor and read properties
		...
		try {
			...
			FileInputStream ip = new FileInputStream(
					"C:\\Users\\sajjad\\Desktop\\SeleniumTraining\\EbayAutomationTest\\src\\main\\java\\com\\ebay\\qa\\config\\config.properties");
			prop.load(ip);
	...
	public static void initialization() {
		...
		if (browsername.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\sajjad\\Desktop\\SeleniumDriver\\Chrome_driver\\chromedriver_win32\\chromedriver.exe");
